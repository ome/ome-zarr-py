...
- {doc}`tutorials/cli_basics` for reading and downloading OME-NGFF filesets.
- {doc}`api` for reading and writing OME-NGFF filesets.
- Used by the [napari-ome-zarr](https://github.com/ome/napari-ome-zarr) plugin for viewing OME-NGFF filesets in [napari](https://github.com/napari/napari).
